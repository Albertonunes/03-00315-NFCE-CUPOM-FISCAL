...
type
  TDMD_PRO00315 = class(TDataModule)
    ...
    QryCstPedSTATUS: TStringField;
    QryCstPedTOTAL_PEDIDO: TFloatField;
    QryCstPedVENDEDOR_ID: TIntegerField;
    QryCstPedNOME: TStringField;
    QryCstPedVENDEDOR: TStringField;
    QryCstPedEMAIL: TStringField;
    QryCstPedPROD_IMPRESSO: TStringField;
    QryCstPedCOMISSAO: TFloatField;
    QryCstPedFRETE_CONTA: TIntegerField;
    QryCstPedFPGTO_COD: TIntegerField;
    QryCstPedPORTADOR: TStringField;
    QryCstPedESPDOC: TStringField;
    QryCstPedTIPOCOBR: TStringField;
    QryCstPedCATEG: TStringField;
    QryCstPedCLASS: TStringField;
    QryCstPedCONTABIL: TIntegerField;
    QryCstPedCENTROCUSTO: TIntegerField;
    QryCstPedTRANSPORTADORA: TIntegerField;
    QryCstPedORIGEM: TIntegerField;
    QryCstPedASS1: TIntegerField;
    QryCstPedASS2: TIntegerField;
    QryCstPedASS3: TIntegerField;
    QryCstPedASS4: TIntegerField;
    QryCstPedCOD_TABELA: TIntegerField;
    QryCstPedSEUPEDIDO: TIntegerField;
    QryCstPedTIPO: TIntegerField;
    QryCstPedQUANT_ITENS: TFloatField;
    QryCstPedVLRFRETE: TFloatField;
    QryCstPedCOMPRADOR: TStringField;
    QryCstPedPERC_DESC: TFloatField;
    QryCstPedVLR_DESC: TFloatField;
    QryCstPedPEDIDOCLI: TStringField;
    QryCstPedFOBCIF: TIntegerField;
    QryCstPedFILIAL: TIntegerField;
    QryCstPedPA: TIntegerField;
    QryCstPedDATA: TSQLTimeStampField;
    QryCstPedPRAZO_ENTREGA: TStringField;
    QryCstPedDT_ENTREGA: TSQLTimeStampField;
    QryCstPedDT_FECHAMENTO: TSQLTimeStampField;
    QryCstPedDATA_FATURAMENTO: TSQLTimeStampField;
    QryCstPedFILIAL_PEDIDO: TIntegerField;
    QryCstPedPEDID: TFDAutoIncField;
    QryCstPedVLR_IPI: TFloatField;
    QryCstPedVLR_ICMS: TFloatField;
    QryCstPedVLR_ICMSSUB: TFloatField;
    QryCstPedVLR_MERCADORIA: TFloatField;
    QryBuscaClienteRESTRICAO: TStringField;
    QryBuscaClienteRESTRICAO_OBS: TStringField;
    DsTipoImp: TDataSource;
    QryTipoImp: TFDQuery;
    QryTipoImpTIPOID: TIntegerField;
    QryTipoImpTIPOTIPO: TStringField;
    QryTipoImpTIPONOME: TStringField;
    QryEstoque_id: TFDQuery;
    QryEstoque_idESTOQUE_ID: TIntegerField;
    QryEstoque_idMATERIAL_ID: TIntegerField;
    QryEstoque_idESTOQUE: TFloatField;
    QryEstoque_idRESERVA: TFloatField;
    QryEstoque_idESTOQUE_MIN: TFloatField;
    QryEstoque_idESTOQUE_MAX: TFloatField;
    QryEstoque_idESTOQUE_ID_1: TIntegerField;
    QryEstoque_idESTOQUE_DESCR: TStringField;
    QryEstoque_idESTOQUE_1: TFloatField;
    dsestoque_id: TDataSource;
    ...
    QryTipoCobr: TFDQuery;
    DsrTipoCobr: TDataSource;
    QryTipoCobrCod_TpCobr: TStringField;
    QryTipoCobrDesc_TpCobr: TStringField;
    ...
    QryImprimeNF: TFDQuery;
    QryImprimeNFNF_ID: TFDAutoIncField;
    QryImprimeNFNF_NUMERO: TIntegerField;
    QryImprimeNFSERIE_ID: TIntegerField;
    QryImprimeNFDIAG_EMPRESA: TIntegerField;
    QryImprimeNFCFOP_ID: TIntegerField;
    QryImprimeNFTRANSP_ID: TIntegerField;
    QryImprimeNFGESTOR_CLIENTE: TIntegerField;
    QryImprimeNFNOME: TStringField;
    QryImprimeNFTEXTO_LEGAL_ID: TIntegerField;
    QryImprimeNFVENDEDOR_ID: TIntegerField;
    QryImprimeNFSEUPEDIDO: TStringField;
    QryImprimeNFPEDIDO_ID: TIntegerField;
    QryImprimeNFVIA_TRANSP_ID: TIntegerField;
    QryImprimeNFNF_DT_EMISSAO: TSQLTimeStampField;
    QryImprimeNFNF_DT_ENT_SAI: TSQLTimeStampField;
    QryImprimeNFNF_ALIQ_ICMS: TFloatField;
    QryImprimeNFNF_VLR_TOTAL: TFloatField;
    QryImprimeNFNF_ALIQ_ISS: TFloatField;
    QryImprimeNFNF_VLR_TOTMERC: TFloatField;
    QryImprimeNFNF_VLR_TOTSERV: TFloatField;
    QryImprimeNFNF_VLR_BASE_ICMS: TFloatField;
    QryImprimeNFNF_VLR_BASE_IPI: TFloatField;
    QryImprimeNFNF_VLR_BASE_ISS: TFloatField;
    QryImprimeNFNF_VLR_BASE_ICMSUB: TFloatField;
    QryImprimeNFNF_VLR_ICMS: TFloatField;
    QryImprimeNFNF_VLR_IPI: TFloatField;
    QryImprimeNFNF_VLR_ISS: TFloatField;
    QryImprimeNFNF_VLR_ICMSUB: TFloatField;
    QryImprimeNFNF_VLR_FRETE: TFloatField;
    QryImprimeNFNF_VLR_SEGURO: TFloatField;
    QryImprimeNFNF_VLR_OUTRAS: TFloatField;
    QryImprimeNFNF_FRETEXCONTA: TStringField;
    QryImprimeNFNF_PLACA: TStringField;
    QryImprimeNFNF_PLACA_UF: TStringField;
    QryImprimeNFNF_OBS1: TStringField;
    QryImprimeNFNF_OBS2: TStringField;
    QryImprimeNFNF_OBS3: TStringField;
    QryImprimeNFNF_OBS4: TStringField;
    QryImprimeNFNF_OBS5: TStringField;
    QryImprimeNFNF_OBS6: TStringField;
    QryImprimeNFNF_OBS7: TStringField;
    QryImprimeNFNF_VOL_MARCA: TStringField;
    QryImprimeNFNF_VOL_NUMERO: TStringField;
    QryImprimeNFNF_VOL_QTDE: TIntegerField;
    QryImprimeNFNF_VOL_ESPECIE: TStringField;
    QryImprimeNFNF_VOL_PESO: TFloatField;
    QryImprimeNFNF_VOL_PESOBRUTO: TFloatField;
    QryImprimeNFSTATUS: TStringField;
    QryImprimeNFIDORIG: TStringField;
    QryImprimeNFCALCULA_IMPOSTO: TStringField;
    QryImprimeNFNF_FISCAL1: TStringField;
    QryImprimeNFNF_FISCAL2: TStringField;
    QryImprimeNFNF_FISCAL3: TStringField;
    QryImprimeNFNF_FISCAL4: TStringField;
    QryImprimeNFNF_FISCAL5: TStringField;
    QryImprimeNFNF_FISCAL6: TStringField;
    QryImprimeNFENDERECO: TStringField;
    QryImprimeNFENDERECO_NUM: TIntegerField;
    QryImprimeNFENDERECO_COMPL: TStringField;
    QryImprimeNFCODCID_IBGE: TIntegerField;
    QryImprimeNFUF_IBGE: TStringField;
    QryImprimeNFCIDADE: TStringField;
    QryImprimeNFUF: TStringField;
    QryImprimeNFCNPJ: TStringField;
    QryImprimeNFCEP: TStringField;
    QryImprimeNFBAIRRO: TStringField;
    QryImprimeNFIE: TStringField;
    QryImprimeNFFONE: TStringField;
    QryImprimeNFFPAGTO: TStringField;
    QryImprimeNFFPGTO_VPO: TStringField;
    QryImprimeNFTIPO: TStringField;
    QryImprimeNFTRANSPORTADORA: TStringField;
    QryImprimeNFNFE_MODELO: TStringField;
    QryImprimeNFNFE_SERIE: TStringField;
    QryImprimeNFNFE_FINALIDADE: TStringField;
    QryImprimeNFNFE_RECIBO: TStringField;
    QryImprimeNFNFE_PROTOCOLO: TStringField;
    QryImprimeNFNFE_IDNOTA: TStringField;
    QryImprimeNFNFE_DTENVIO: TSQLTimeStampField;
    QryImprimeNFNFE_STATUS: TStringField;
    QryImprimeNFNFE_CODSTATUS: TIntegerField;
    QryImprimeNFNFE_NROCANCELAMENTO: TStringField;
    QryImprimeNFSITUACAO: TStringField;
    QryImprimeNFNFE_REFERENCIADA: TIntegerField;
    QryImprimeNFNF_VLR_TOTDESC: TFloatField;
    QryImprimeNFNF_XML: TMemoField;
    QryImprimeNFVENDEDOR2: TIntegerField;
    QryImprimeNFENVIADO_XML: TStringField;
    QryImprimeNFVLR_RETENCAO: TFloatField;
    QryImprimeNFMANIFESTO: TIntegerField;
    QryImprimeNFVLR_FCP: TFloatField;
    QryImprimeNFNSU: TIntegerField;
    QryImprimeNFVLR_IBS: TFloatField;
...
begin
  ...
  QryFiltroDuplicataNF_NUMERO.Value := QryFiltroNFNF_NUMERO.Value;
end;
